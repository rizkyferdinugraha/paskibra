...
<html lang="en">
    ...
    <body>
        ...
        <script src="{{ asset('mazer/assets/static/js/components/burger.js') }}"></script>
        ...
        <script src="{{ asset('mazer/assets/extensions/filepond-plugin-image-resize/filepond-plugin-image-preview.min.js') }}"></script>
